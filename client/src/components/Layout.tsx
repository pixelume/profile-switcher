  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="flex-grow flex">
        {/* Sidebar */}
        <aside
          className={`bg-secondary text-secondary-foreground w-64 p-4 transition-all duration-300 ease-in-out ${
        ...
        >
          <nav className="space-y-2">
            <a
              href="/admin"
              className="flex items-center space-x-2 p-2 rounded hover:bg-primary/10"
            >
