      ...
      <Tabs defaultValue="users" className="space-y-4">
        ...
        <TabsContent value="permissions" className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <Button
              onClick={() =>
                handleCreate("permissions", { name: "New Permission" })
              }
            >
              Create Permission
            </Button>
                  ...
                  <TableCell>
                    <div className="flex space-x-2">
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          handleUpdate("permissions", permission.id, {
                            ...permission,
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          handleDelete("permissions", permission.id)
                        }
                      >
                        Delete
                      </Button>
